...
def initial_greetings():
    ...
    if (hour>=0 and hour<=12):
        speak("Wake up, Good morning.. it's time to get going!!")
    elif(hour>=12 and hour<=18):
        speak("Good Afternoon, get going!")
    else:
        speak("Good Evening, get going!")

    speak("please tell me how may i help you.. What are you looking for?")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'open notepad' in query:
            ...
            browser_access("https:\\www.youtube.com")

        elif 'open google' in query:
            browser_access("https:\\www.google.co.in")
           ...
           browser_access("https://www.youtube.com/channel/UCj22tfcQrWG7EMEKS0qLeEg")
            ...
            browser_access("https:\\in.linkedin.com")

        elif 'open code' in query:
            codePath = "C\\Users\\Nagashree\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
            os.startfile(codePath)

        elif 'open chatgpt' in query:
            browser_access("chat.openai.com")

        elif 'email to a friend' in query:
            try:
                speak("Speak up your content")
                content = accept_input()
                to="nagashreel40@gmail.com"
